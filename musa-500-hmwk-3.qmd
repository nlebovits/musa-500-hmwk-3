...
Since the ROC curve can be used to plot true positive rate against false positive rate and determine the quality of the model, a ROC curve is plotted for our model. 
...
Given the ROC curve as presented above, we then calculated the area under curve to further measure the accuracy of the model. 
